 ...
 * runs as a thread. When a simplechat.client is thus connected to the
...
public abstract class AbstractServer implements Runnable
{
    ...
    /**
     * The thread group associated with simplechat.client threads. Each member of the
...
// INSTANCE METHODS *************************************************
     ...
     * Any exception thrown while closing a simplechat.client is ignored.
    ...
    final synchronized public void close() throws IOException
    {
        ...
        {
            // Close the simplechat.client sockets of the already connected clients
    ...
    /**
     * Sends a message to every simplechat.client connected to the server.
     ...
     * sending the message to a particular simplechat.client is ignored.
     *
...
// ACCESSING METHODS ------------------------------------------------
     ...
     * simplechat.client connections. This can be used by
...
// RUN METHOD -------------------------------------------------------
    ...
    final public void run()
    {
        ...
        try
        {
            // Repeatedly waits for a new simplechat.client connection, accepts it, and
            ...
            while (!readyToStop)
            {
                try
                {
                    ...
                    // When a simplechat.client is accepted, create a thread to handle
...
// METHODS DESIGNED TO BE OVERRIDDEN BY CONCRETE SUBCLASSES ---------
    ...
    /**
     * Hook method called each time a new simplechat.client connection is
     * accepted. The default implementation does nothing.
     *
     * @param client the connection connected to the simplechat.client.
     */
    ...
    /**
     * Hook method called each time a simplechat.client disconnects.
     * The default implementation does nothing. The method
     * may be overridden by subclasses but should remains synchronized.
     *
     * @param client the connection with the simplechat.client.
     */
     ...
     * synchronized.
     *
     * @param client    the simplechat.client that raised the exception.
    ...
    /**
     * Handles a command sent from one simplechat.client to the server.
     ...
     * @param client the connection connected to the simplechat.client that
     *               sent the message.
     */
...
// METHODS TO BE USED FROM WITHIN THE FRAMEWORK ONLY ----------------
    ...
    /**
     * Receives a command sent from the simplechat.client to the server.
